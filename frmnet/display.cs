...
namespace frmnet
{
    public partial class display : Form
    {
        ...
        private void Display_Load(object sender, EventArgs e)
        {
            ...
            timer1.Enabled = true;
            distxt.HideSelection = false;
            distxt.Font=new Font(FontFamily.GenericSerif,20);
            linewidth = distxt.ClientSize.Width;
            linewidth = linewidth/(int)distxt.Font.Size;
            step = linewidth;
            tempArray = distxt.Lines;
            maintxt = distxt.Text;
        ...
        private void Distxt_SizeChanged(object sender, EventArgs e)
        {
            Size s = distxt.ClientSize;
        }

        private void Display_ClientSizeChanged(object sender, EventArgs e)
        {
            distxt.Size = this.ClientSize;
            linewidth = distxt.ClientSize.Width /(int) distxt.Font.Size;
        }
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (lineid<tempArray.Count())
            {
                // distxt.SelectionColor = Color.Red;
                //distxt.SelectionBackColor = Color.Plum;
                //distxt.Select(start, tempArray[lineid].Length);
               
                if (tempArray[lineid]!="")
                {
                start= distxt.Text.IndexOf(tempArray[lineid]);
                    distxt.Select(start, linewidth< tempArray[lineid].Length ? linewidth:tempArray[lineid].Length);
                }
